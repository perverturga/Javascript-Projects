...
function computerRandomChoice(){
    ...
    //  console.log(computerChoiceNumber);  console.log(computerChoiceNumber);
// random sayı seçimine göre rock paper seçiliyor
...
function  updateScore(playerChoice) {
    ...
    if(playerChoice === computerChoice) {
        ...
        if(choice.win.indexOf(computerChoice) === 0){
            playerScoreNumber++;
            resultText.textContent = "Deran Akdoğan Kazandı."
            playerScore.textContent = playerScoreNumber;
            startConfetti();
        } else {
            computerScoreNumber++;
            resultText.textContent = "Perver Turga Kazandı.";
            computerScore.textContent = computerScoreNumber;
        }
    }
}
...
//! indexte onclick özelliğinde select içine paper rock parametrelerini ben verdim
